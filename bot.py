...
# (بقیه callbackهای بازی، wallet، admin_panel، upload_file، publish_group، manage_groups و ... را از کد اصلی خودت کپی کن)

# ======== جستجوی کاربر (محدود شده) ========
@dp.message(lambda msg: msg.from_user.id == ADMIN_ID and msg.text and len(msg.text.split()) == 1 and not msg.text.startswith('/'))
