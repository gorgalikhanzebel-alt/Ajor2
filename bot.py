...
def admin_menu():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("🗑 حذف کاربر", callback_data="delete_user")],
        [InlineKeyboardButton("⚙️ تنظیمات گروه", callback_data="group_settings")],
        [InlineKeyboardButton("🔙 برگشت", callback_data="back_main")]
    ])
...
@dp.message(lambda msg: msg.text and msg.reply_to_message and msg.reply_to_message.text and "پیام همگانی" in msg.reply_to_message.text)
